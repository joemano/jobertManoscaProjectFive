    ...
    return(
      <div className="credits container">
        ...
        <div className="creditsContent">
          <div className="storeButtons creditItem">
            <h3>Download Azur Lane</h3>
            <div className="buttonFlex">
              <div className="appStore" id="#appStoreBadge">
              ...
              <div className="playStore" id="#playStoreBadge">
          ...
          <div className="externalLinksHolder creditItem">
          ...
          <div className="smLinksHolder creditItem">
            <ul className="smLinks">
              <li>
                <a href="https://www.facebook.com/AzurLaneEN/" target="_blank"><i className="fab fa-facebook"></i></a>
              </li>
              <li>
                <a href="https://twitter.com/AzurLane_EN" target="_blank"><i className="fab fa-twitter"></i></a>
              </li>
              <li>
                <a href="https://www.youtube.com/channel/UCPeJaqP6WgxUVDcpYkXZKMQ" target="_blank"><i className="fab fa-youtube"></i></a>
              </li>
              <li>
                <a href="https://www.reddit.com/r/AzureLane/" target="_blank"><i className="fab fa-reddit"></i></a>
              </li>
              <li>
                <a href="https://www.twitch.tv/directory/game/Azur%20Lane" target="_blank"><i className="fab fa-twitch"></i></a>
              </li>
              <li>
                <a href="https://discord.gg/WYjqf7P" target="_blank"><i className="fab fa-discord"></i></a>
              </li>
            </ul>
          </div>
        </div>
